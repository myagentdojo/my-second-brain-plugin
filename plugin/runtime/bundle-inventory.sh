...
runtime_inventory_select_bundle() {
	case "$1" in
	'agent-browser')
		RUNTIME_BUNDLE_PATH='runtime/warm-browser-d9f7ec575dc2c9d7.js'
		RUNTIME_BUNDLE_BYTES='45780'
		RUNTIME_BUNDLE_SHA256='d9f7ec575dc2c9d74d9d2c07ea3b064edc6f94784d44f64c92d1b0d0fbd09519'
		;;
	'frontier-runner')
