...
runtime_inventory_select_bundle() {
	case "$1" in
	'agent-browser')
		RUNTIME_BUNDLE_PATH='runtime/warm-browser-4b80bf12b401cecc.js'
		RUNTIME_BUNDLE_BYTES='132412'
		RUNTIME_BUNDLE_SHA256='4b80bf12b401cecc053bce310123ba0a0773051cde06801ce165addf1f3ba8ca'
		;;
	'frontier-runner')
