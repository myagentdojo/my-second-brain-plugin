...
├── skills/{capability-tour,dev-mode,frontier-runner,handoff-to-opus,hello-world,new-note,new-plugin,new-project,new-skill,orchestrate-spec,orchestration-design,runtime-custody,skill-a,skill-b,ultragoal}/SKILL.md
