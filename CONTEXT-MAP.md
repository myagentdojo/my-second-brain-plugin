...
| **Agent Browser** | [`plugin/skills/agent-browser/CONTEXT.md`](./plugin/skills/agent-browser/CONTEXT.md) | None. | `plugin/skills/agent-browser/**` and `packages/agent-browser/**`: Agent Browser, Warm Browser, Agent Chrome Profile, Browser Session, Controlled Page, Snapshot Reference, Credential Vault, Credential Match, Private Delivery, and Profile Cutover. |
